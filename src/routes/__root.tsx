...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Plateforme d'investissement solaire en Afrique de l'Ouest. Gagnez jusqu'à 15% par jour. Démo pédagogique sur les systèmes de Ponzi." },
      { property: "og:title", content: "Fadoul Investment" },
      { property: "og:description", content: "Investissez dans le soleil. Récoltez chaque jour." },
